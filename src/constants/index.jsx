...
export const CONTACT = [
  { key: "address", value: "Address: C5/104 Asifabad Green Town Karachi" },
  { key: "phone", value: "Phone: +92342-2709496" },
  { key: "email", value: "Email: Bilalfiaz802@gmail.com" },
];

export const SOCIAL_MEDIA_LINKS = [
  {
    href: "https://www.facebook.com/bilal.fayyaz1",
    icon: <FaFacebook fontSize={30} className="hover:opacity-80" />,
  },

  {
    href: "https://www.instagram.com/bubby_bhai/",
    icon: <FaInstagram fontSize={30} className="hover:opacity-80" />,
  },
  {
    href: "https://www.linkedin.com/in/bilalfayaz/",
